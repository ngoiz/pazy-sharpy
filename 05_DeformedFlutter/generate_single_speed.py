...
if __name__== '__main__':
    ...
    for i, u_inf in enumerate(u_inf_vec):
        ...
        try:
            generate_pazy(u_inf, case_name, output_folder='/output_single_speed/pazy_M{:g}N{:g}Ms{:g}_alpha{:04g}_skin{:g}/'.format(M, N, Ms, alpha*100, skin_on),
                          cases_subfolder='/single_speed/M{:g}N{:g}Ms{:g}_skin{:g}/'.format(M, N, Ms, skin_on),
